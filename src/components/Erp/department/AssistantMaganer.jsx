...
const AssistantMaganer = (props) => {
    ...
    useEffect(() => {
        const fetchEmp = async ()=> {
            const response = await fetch(`${API_URL}/dept?deptname=${props.deptname}&emprank=${emprank}`);
            const emp = await response.json();
            console.log("emp: ", emp);            
            setEmp(emp);
        };  
        fetchEmp();
    }, [props.deptname, emprank]);
...
export default AssistantMaganer;